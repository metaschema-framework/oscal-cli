...
class Issue96ClassLoaderTest {
  ...
  void testAssessmentPlanClassLoader() {
    AbstractOscalConvertCommand subcommand
        = new dev.metaschema.oscal.tools.cli.core.commands.assessmentplan.ConvertSubcommand();
  ...
  void testAssessmentResultsClassLoader() {
    AbstractOscalConvertCommand subcommand
        = new dev.metaschema.oscal.tools.cli.core.commands.assessmentresults.ConvertSubcommand();
  ...
  void testCatalogClassLoader() {
    AbstractOscalConvertCommand subcommand
        = new dev.metaschema.oscal.tools.cli.core.commands.catalog.ConvertSubcommand();
  ...
  void testPoamClassLoader() {
    AbstractOscalConvertCommand subcommand
        = new dev.metaschema.oscal.tools.cli.core.commands.poam.ConvertSubcommand();
  ...
  void testSspClassLoader() {
    AbstractOscalConvertCommand subcommand
        = new dev.metaschema.oscal.tools.cli.core.commands.ssp.ConvertSubcommand();
  ...
  void testComponentDefinitionClassLoader() {
    AbstractOscalConvertCommand subcommand
        = new dev.metaschema.oscal.tools.cli.core.commands.componentdefinition.ConvertSubcommand();
